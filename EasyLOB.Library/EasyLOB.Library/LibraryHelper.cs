...
namespace EasyLOB.Library
{
    ...
    public static partial class LibraryHelper
    {
        ...
        public static object StringToTypedObject(string value, Type type)
        {
            ...
            switch (typeCode)
            {
                case TypeCode.Boolean:
                    result = value.StringToBooleanNullable();
                    break;

                case TypeCode.Byte:
                    result = value.StringToByteNullable();
                    break;
                //case TypeCode.SByte:
                //    result = StringToSingleNullable(value);
                //    break;
                case TypeCode.Char:
                    result = value.StringToCharNullable();
                    break;

                case TypeCode.Decimal:
                    result = value.StringToDecimalNullable();
                    break;

                case TypeCode.Double:
                    result = value.StringToDoubleNullable();
                    break;

                case TypeCode.Single:
                    result = value.StringToSingleNullable();
                    break;

                case TypeCode.Int16:
                    result = value.StringToInt16Nullable();
                    break;
                //case TypeCode.UInt16:
                //    result = StringToUInt16Nullable();
                //    break;
                case TypeCode.Int32:
                    result = value.StringToInt32Nullable();
                    break;
                //case TypeCode.UInt32:
                //    result = StringToUInt32Nullable();
                //    break;
                case TypeCode.Int64:
                    result = value.StringToInt64Nullable();
                    break;
                //case TypeCode.UInt64:
                //    result = StringToUInt64Nullable();
                //    break;
                case TypeCode.Object:
                    switch (GetTypeName(type))
                    {
                        case "System.Guid":
                            result = value.StringToGuidNullable();
                            break;
                    }
                    break;

                case TypeCode.String:
                    result = value.StringToStringNullable();
                    break;
            }
        ...
        #region Methods ConfigurationManager
        ...
        public static T AppSettings<T>(string name)
        {
            ...
            if (appSetting == null)
            {
                throw new Exception(String.Format("AppSettings[\"{0}\"] = \"?\"", name));
            }
        ...
        #endregion Methods ConfigurationManager
        ...
        public static void Clone<T>(T from, T to)
        {
            Clone(from, to, null);
        }

        public static void Clone<T>(T from, T to, List<string> excludedProperties)
        {
        ...
        {
            const BindingFlags bindingFlags = BindingFlags.InvokeMethod | BindingFlags.Static | BindingFlags.NonPublic | BindingFlags.Public;
        ...
        public static object InvokeMethod(object instance, string methodName, object[] args)
        {
            ...
            const BindingFlags bindingFlags = BindingFlags.InvokeMethod | BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public;
            MethodInfo method = type.GetMethod(methodName, bindingFlags);
        ...
        {
            Type type = instance.GetType();
            BindingFlags bindingFlags = BindingFlags.GetProperty | BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Static;
        ...
        {
            BindingFlags bindingFlags = BindingFlags.GetProperty | BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Static;
            PropertyInfo property = type.GetProperty(propertyName, bindingFlags);
