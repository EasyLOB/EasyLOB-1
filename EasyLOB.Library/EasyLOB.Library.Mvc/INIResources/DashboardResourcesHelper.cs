...
{
    public static class DashboardResourcesHelper
    {
        private static IIniManager iniManager = new IniManager(HttpContext.Current.Server.MapPath("~/EasyLOB/INI/DashboardResources.ini"));
