...
{
    public static class ReportResourcesHelper
    {
        private static IIniManager iniManager = new IniManager(HttpContext.Current.Server.MapPath("~/EasyLOB/INI/ReportResources.ini"));
