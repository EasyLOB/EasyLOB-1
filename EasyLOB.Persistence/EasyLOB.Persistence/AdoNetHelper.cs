...
namespace EasyLOB.Persistence
{
    ...
    public static partial class AdoNetHelper
    {
        ...
        {
            get { return LibraryHelper.AppSettings<string>("AdoNet.SequencePrefix"); }
        }
        ...
        {
            get { return LibraryHelper.AppSettings<int>("AdoNet.RecordsBySearch"); }
        }
        ...
        public static ZDBMS GetDBMS(string connection)
        {
            ...
            //DbProviderFactory provider = GetProvider(connection); // Connection Name
            //if (provider != null)
            //{
            //    return GetDBMS(provider);
            //}
            //else
            //{
            //    return ZDBMS.Unknown;
